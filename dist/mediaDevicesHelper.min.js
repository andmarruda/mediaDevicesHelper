 ...
 * @author  Anderson Arruda < anderson@sysborg.com.br >
 * @license MIT
 */class recorder{constructor(e){this._allowedVideoTypes={mp4:"video/mp4",mpeg:"video/mpeg",ogv:"video/ogg",webm:"video/webm"},this._allowedAudioTypes={aac:"audio/aac",mp3:"audio/mpeg",wav:"audio/wav",oga:"audio/ogg",weba:"audio/webm"},this._mediaDevice=e,this._recorder=new MediaRecorder(this.mediaDevice),this._data=[],this._time=0,this._recording=!1,this._error,this._limit=-1;var i=this;this._recorder.ondataavailable=e=>i._data.push(e.data),this._recorder.onstart=()=>i._countTime(),this._recorder.onresume=()=>i._countTime(),this._recorder.onstop=()=>i._stopCountTime(),this._recorder.onerror=e=>{i.stop(),i._error=e.name}}setLimit(e){this._limit=1e3*e}_countTime(){this._recording=!0;var e=this;this._interval=setInterval((()=>{e._time++}),1e3)}_stopCountTime(){this._recording=!1,clearInterval(this._interval)}start(){this._time=0,this._recorder.start();var e=this;this._limit>-1&&wait(this._limit).then((()=>{e.stop()}))}resume(){this._recorder.resume()}stop(){this._recorder.stop()}status(){return this._recording}getTime(){return this._time}getError(){return this._error}getBlob(e){this.getStatus()&&this.stop();return new Blob(this._data,{type:this._allowedAudioTypes[e]||this._allowedVideoTypes[e]})}getAudio(e){const i=this.getBlob(mimeType);return new File([i],`audio.${e}`,{type:this._allowedAudioTypes[e],lastModified:Date.now()})}getVideo(e){const i=this.getBlob(e);return new File([i],`video.${e}`,{type:this._allowedVideoTypes[e],lastModified:Date.now()})}}